...
//    CopyBoardcodesFile(pathToBuiltProject);
    CreateVersionTxt();
    UpdateVersionTxt();
    UpdateAndroidBuildVersion(target);
  ...
  private static void UpdateAndroidBuildVersion(BuildTarget target){
    if(target == BuildTarget.Android){
      Debug.Log("updating Android Bundle Version Code. from: "+PlayerSettings.Android.bundleVersionCode);
      PlayerSettings.Android.bundleVersionCode = PlayerSettings.Android.bundleVersionCode+1;
      Debug.Log("updating Android Bundle Version Code. to: "+PlayerSettings.Android.bundleVersionCode);
    }
  }
